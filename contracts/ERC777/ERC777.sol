...
import "github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.5.0/contracts/token/ERC777/IERC777Sender.sol";
...
import "github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.5.0/contracts/utils/Address.sol";
...
contract ERC777 is Context, IERC777, IERC20, Pausable, ERC1820Context {
    ...
    */
    function transferFrom(address holder, address recipient, uint256 amount) public whenNotPaused returns (bool) {
        require(recipient != address(0), "ERC777: transfer to the zero address");
